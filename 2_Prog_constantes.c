...
#define DOWHILE(x,y) do while(x<y)
...
int main(void)
{
	...
	/*Utilizando en ciclo while*/
	printf("Utilizando en ciclo while\n");
	x=0;
	CICLOWHILE(x, y)
	{
		printf("\n Imprimiendo con el ciclo while\n");
		x++;
	}
	...
	printf("Impresión de constantes con const\n");
	printf("%.4f\n",pi);
	printf("%.2f\n",g);
	printf("%d\n",tamanio);
	printf("%d\n",min);
